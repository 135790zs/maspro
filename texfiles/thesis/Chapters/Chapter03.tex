...
\section{Optimizer}\label{sec:adam}
	...
	Empirical observations on the resulting learning curves (see Chapter \ref{ch:results}) suggest that this procedure does not hamper a rapid initial decrease of the loss function.
