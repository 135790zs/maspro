...
\section{Enhancing e-prop}
	...
	\subsection{Multi-layer architecture}
		...
		\begin{figure}[bth]
		    ...
		    \subfloat[A multi-layer network with two stacked recurrent layers. Some details shown in Figure (\ref{fig:topology} b) are omitted for clarity]
