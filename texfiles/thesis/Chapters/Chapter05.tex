...
However, the Izhikevich neuron also shows STDP behavior, suggesting that the STDP-ALIF neuron works by virtue of another factor, such as its spike frequency adaptation which the Izhikevich neuron does not have.

Rearranging the neurons into a stacked architecture does not improve the classification performance.
