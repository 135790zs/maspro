...
Furthermore, the two new STDP neuron models that were suggested in \citet{traub2020learning} are experimentally verified in the TIMIT phone classification task.
...
If this is the case, the STDP-ALIF neuron model may lead to better learning algorithms in neuromorphic systems.
