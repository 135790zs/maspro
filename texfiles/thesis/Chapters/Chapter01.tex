...
Their sparse firing regimes also offer improved interpretability of their behavior as compared to traditional ANNs \citet{soltic2010knowledge}, which is desired in areas such as medicine or aviation.
...
Synaptic plasticity was demonstrated using synaptic plasticity in deep feedforward SNNs \citep{zenke2018superspike,neftci2017event,kaiser2020synaptic} and could be implemented in feedforward VLSIs, but \citet{zenke2018superspike} notes that these methods are applicable for RSNNs.
